...
/* user/show.html.twig */
class __TwigTemplate_723021882452fc8b2bbad80c894ce1a7112804d6564c84bc82f2f25a85ecf2d2 extends Template
{
    private $source;
    private $macros = [];
    ...
    <a href=\"";
        // line 27
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("user_edit", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 27, $this->source); })()), "id", [], "any", false, false, false, 27)]), "html", null, true);
        echo "\">edit</a>
...
{% endblock %}
", "user/show.html.twig", "C:\\Users\\ya39o\\OneDrive\\Desktop\\test\\templates\\user\\show.html.twig");
    }
}
